...
import com.PrestaShop.Cookies.ReadCookies;
...
public class LoginPage extends PageGenerator {
	...
	@Step("Вход в админ-панель PrestaShop при помощи Cookies.")
	public UserPage enterWithCookie() {

		ReadCookies.readCookies(driver);
		return getInstance(UserPage.class);
	}
	
	@Step("Вход в админ-панель PrestaShop.")
