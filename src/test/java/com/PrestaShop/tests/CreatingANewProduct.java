...
public class CreatingANewProduct extends InitialConfiguration {
	...
	public void createANewProduct() {
		...
		CreateProduct createProduct = page.getInstance(LoginPage.class).enterWithCookie().selectCatalog().goToProduct()
		...
		Product prod = page.getInstance(HomePage.class).signIn().clickOnAllProduct().clickOnProduct(productsName);
